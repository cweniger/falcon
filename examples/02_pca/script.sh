...
for net_type in nice; do
    ...
    falcon swarm logging.project=falcon_tmp3 logging.group=zuko_${net_type}_v4 graph.z.estimator.net_type=zuko_${net_type} \
...
#    falcon sample posterior wandb.project=falcon_tmp3 wandb.group=zuko_${net_type}_v4 graph.z.estimator.net_type=zuko_${net_type} \
#	    directories.sim_dir=/scratch-local/cweniger/sim_dir \
#	    directories.graph_dir=/scratch-local/cweniger/graph_dir
done
